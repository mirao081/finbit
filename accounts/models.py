...
class QuickAction(models.Model):
    ...
    url_name = models.CharField(
        max_length=50,
        help_text="Django URL name for this action",
    )
...
class ProfilePage(models.Model):
    ...
    subheading = models.CharField(
        max_length=300,
        default="Manage your account, investments, security and wallets",
    )

    personal_info_heading = models.CharField(
        max_length=200,
        default="Personal Information",
    )

    investment_summary_heading = models.CharField(
        max_length=200,
        default="Investment Summary",
    )

    recent_investments_heading = models.CharField(
        max_length=200,
        default="Recent Investments",
    )

    quick_actions_heading = models.CharField(
        max_length=200,
        default="Quick Actions",
    )

    referral_heading = models.CharField(
        max_length=200,
        default="Referral Program",
    )

    account_settings_heading = models.CharField(
        max_length=200,
...
class AnnouncementReply(models.Model):
    ...
    def __str__(self):
        return (
            f"Reply by {self.user.username} "
            f"on {self.announcement.title}"
        )
