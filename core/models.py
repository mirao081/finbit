...
class SiteSettings(models.Model):
    ...
    hero_title_gold = models.CharField(
        max_length=100,
        default="Finbit"
    )
    ...
    hero_subtitle = models.CharField(
        max_length=255,
        default="Your modern financial platform."
    )
    ...
    about_content = models.TextField(
        default="We are building the future of finance with blockchain innovation."
    )
...
class PaymentSection(models.Model):
    heading = models.CharField(
        max_length=200,
        default="Payment We Accept"
    )

    subheading = models.CharField(
        max_length=300,
        default="We support multiple payment methods for your convenience."
    )
...
class NewsSection(models.Model):
    ...
    subheading = models.CharField(
        max_length=300,
        default="Stay updated with our latest updates."
    )
...
class SupportInfo(models.Model):
    ...
    detail_line1 = models.CharField(
        max_length=255,
        blank=True,
        null=True
    )

    detail_line2 = models.CharField(
        max_length=255,
        blank=True,
        null=True
    )
