...
def all_plans(request):
    ...
    plans = InvestmentPlan.objects.all()   
    footer = SiteFooter.objects.first()
    return render(request, "core/all_plans.html", {
        "site_settings": site_settings,
        "menu_items": menu_items,
        "plans": plans,   
        "footer":footer,
